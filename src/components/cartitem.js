      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-7">
          <div className="p-3">
            ...
            <p className="cart-item-id"> prix du Produit: <b className='text-center mb-1'>dh{price}</b></p>
            <p className="cart-item-id"> Nombre du Produit: <b className='text-center mb-3'>{id}</b></p>
            <p className="cart-item-id">Articles en stock: <b className='text-danger'>{itemsInStock}</b></p>
          </div>
